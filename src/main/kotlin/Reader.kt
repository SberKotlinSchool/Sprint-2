...
fun lines(FOLDERNAME: String) = ProblemA::class.java.getResource("$FOLDERNAME/input.txt")!!.readText()
    .split(if (System.getProperty("os.name").lowercase().contains("windows")) "\r\n" else "\n")
